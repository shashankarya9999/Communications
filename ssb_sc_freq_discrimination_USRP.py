...
class ssb_sc_freq_discrimination_USRP(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "ssb_sc_freq_discrimination_USRP")
        ...
        self.band_pass_filter_0_0 = filter.interp_fir_filter_fff(
            ...
            firdes.band_pass(
                ...
                window.WIN_HAMMING,
                6.76))
        self.band_pass_filter_0_0.set_block_alias("LSB")
        ...
        self.connect((self.band_pass_filter_0_0, 0), (self.blocks_throttle_0, 0))
        self.connect((self.band_pass_filter_0_1, 0), (self.blocks_complex_to_float_0_1, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.band_pass_filter_0_0.set_taps(firdes.band_pass(1, self.samp_rate, self.fc-self.fm, self.fc, 1, window.WIN_HAMMING, 6.76))
        self.band_pass_filter_0_1.set_taps(firdes.band_pass(1, self.samp_rate, self.fc-self.fm, self.fc+self.fm, 1, window.WIN_HAMMING, 6.76))
...
def main(top_block_cls=ssb_sc_freq_discrimination_USRP, options=None):
