...
class hilbert_transform(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "hilbert_transform", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("hilbert_transform")
        ...
        self.settings = Qt.QSettings("GNU Radio", "hilbert_transform")
        ...
        self.hilbert_fc_0 = filter.hilbert_fc(64, window.WIN_RECTANGULAR, 6.76)
        ...
        self.connect((self.blocks_complex_to_float_0, 1), (self.qtgui_freq_sink_x_0_1, 0))
        self.connect((self.blocks_complex_to_float_0, 0), (self.qtgui_time_sink_x_0_0_0, 0))
        self.connect((self.blocks_complex_to_float_0, 1), (self.qtgui_time_sink_x_0_0_0_0, 0))
...
def main(top_block_cls=hilbert_transform, options=None):
