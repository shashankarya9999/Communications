...
# Title: ssb_sc_phase_discrimination_USRP
# Author: shashank
...
class ssb_sc_phase_discrimination_USRP(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "ssb_sc_phase_discrimination_USRP")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("ssb_sc_phase_discrimination_USRP")
        ...
        self.settings = Qt.QSettings("GNU Radio", "ssb_sc_phase_discrimination_USRP")
        ...
        self.uhd_usrp_source_1.set_center_freq(1e9, 0)
        ...
        self.qtgui_time_sink_x_0_3.enable_control_panel(True)
        ...
        self.analog_sig_source_x_1 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, fc, carrier_amplitude, 0, 0)
        self.analog_sig_source_x_1.set_block_alias("carrier_signal")
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, fm, msg_amplitude, 0, 0)
        self.analog_sig_source_x_0.set_block_alias("message_signal")
        ...
        self.connect((self.analog_sig_source_x_0, 0), (self.hilbert_fc_1, 0))
        ...
        self.connect((self.analog_sig_source_x_1, 0), (self.qtgui_time_sink_x_0_3, 0))
        self.connect((self.analog_sig_source_x_1_0, 0), (self.blocks_multiply_xx_1, 1))
        self.connect((self.band_pass_filter_0, 0), (self.blocks_complex_to_float_0_1, 0))
        ...
        self.connect((self.blocks_complex_to_float_0_0, 1), (self.blocks_multiply_const_vxx_1_0, 0))
        self.connect((self.blocks_complex_to_float_0_0, 0), (self.blocks_null_sink_0, 0))
        self.connect((self.blocks_complex_to_float_0_1, 0), (self.blocks_multiply_xx_1, 0))
        ...
        self.connect((self.blocks_multiply_const_vxx_0_0, 0), (self.hilbert_fc_0, 0))
        ...
        self.connect((self.blocks_multiply_xx_0_0, 0), (self.qtgui_freq_sink_x_0_2, 0))
        self.connect((self.blocks_multiply_xx_0_0, 0), (self.qtgui_time_sink_x_0_2, 0))
        ...
        self.connect((self.uhd_usrp_source_1, 0), (self.band_pass_filter_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.band_pass_filter_0.set_taps(firdes.band_pass(1, self.samp_rate, self.fc-self.fm, self.fc+self.fm, 1, firdes.WIN_HAMMING, 6.76))
        self.blocks_throttle_0.set_sample_rate(self.samp_rate)
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, 1500, 1, firdes.WIN_HAMMING, 6.76))
...
def main(top_block_cls=ssb_sc_phase_discrimination_USRP, options=None):
