...
class dsb_sc_USRP(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "dsb_sc_USRP")
        ...
        ##################################################
        self.mu = mu = 5
        self.msg_amp = msg_amp = 45.0
        self.samp_rate = samp_rate = 48000
        self.carrier_amp = carrier_amp = msg_amp/mu
        ...
        self.low_pass_filter_0 = filter.fir_filter_fff(
            ...
            firdes.low_pass(
                ...
                window.WIN_HAMMING,
                6.76))
        self.carrierSignal_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 10000, 1, 0, 0)
        ...
        self.band_pass_filter_0 = filter.fir_filter_fff(
            ...
            firdes.band_pass(
                ...
                window.WIN_HAMMING,
                6.76))
        self.analog_sig_source_x_1 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 10000, carrier_amp, 0, 0)
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 1000, msg_amp, 0, 0)
        ...
        self.connect((self.band_pass_filter_0, 0), (self.blocks_multiply_xx_2, 0))
    ...
    def set_mu(self, mu):
        self.mu = mu
        self.set_carrier_amp(self.msg_amp/self.mu)

    def get_msg_amp(self):
        return self.msg_amp

    def set_msg_amp(self, msg_amp):
        self.msg_amp = msg_amp
        self.set_carrier_amp(self.msg_amp/self.mu)
        self.analog_sig_source_x_0.set_amplitude(self.msg_amp)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.band_pass_filter_0.set_taps(firdes.band_pass(1, self.samp_rate, 8000, 12000, 1, window.WIN_HAMMING, 6.76))
    ...
    def set_carrier_amp(self, carrier_amp):
        ...
        self.analog_sig_source_x_1.set_amplitude(self.carrier_amp)




def main(top_block_cls=dsb_sc_USRP, options=None):
