...
class dsb_fc_USRP(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "dsb_fc_USRP", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("dsb_fc_USRP")
        ...
        self.settings = Qt.QSettings("GNU Radio", "dsb_fc_USRP")
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.band_pass_filter_0.set_taps(firdes.band_pass(1, self.samp_rate, 800, 1200, 1, window.WIN_HAMMING, 6.76))
...
def main(top_block_cls=dsb_fc_USRP, options=None):
