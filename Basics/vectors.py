...
# Title: vectors
# Generated: Sun Dec 15 22:02:27 2024
##################################################
...
class vectors(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "vectors")
        ...
        self.analog_sig_source_x_1 = analog.sig_source_c(samp_rate, analog.GR_COS_WAVE, 100, 0.1, 0)
