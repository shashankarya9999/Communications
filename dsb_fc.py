...
class dsb_fc(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.messageSignal = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 100, msg_amp, 0, 0)
        ...
        self.carrierSignal_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 1000, 1, 0, 0)
        self.carrierSignal = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 1000, carrier_amp, 0, 0)
        self.blocks_throttle2_0 = blocks.throttle( gr.sizeof_float*1, samp_rate, True, 0 if "auto" == "auto" else max( int(float(0.1) * samp_rate) if "auto" == "time" else int(0.1), 1) )
        self.blocks_multiply_xx_2 = blocks.multiply_vff(1)
        self.blocks_multiply_xx_1 = blocks.multiply_vff(1)
        self.blocks_multiply_xx_0 = blocks.multiply_vff(1)
        self.blocks_add_xx_0 = blocks.add_vff(1)
        self.analog_const_source_x_1 = analog.sig_source_f(0, analog.GR_CONST_WAVE, 0, 0, mu)
        ...
        self.connect((self.analog_const_source_x_1, 0), (self.blocks_multiply_xx_0, 0))
    ...
    def set_mu(self, mu):
        ...
        self.analog_const_source_x_1.set_offset(self.mu)
    ...
    def set_msg_amp(self, msg_amp):
        ...
        self.set_carrier_amp(self.msg_amp/self.mu)
        self.messageSignal.set_amplitude(self.msg_amp)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, 100, 1, window.WIN_HAMMING, 6.76))
