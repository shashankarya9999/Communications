...
# Title: ssb_sc_phase_discrimination
# Author: shashank
...
class ssb_sc_phase_discrimination(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "ssb_sc_phase_discrimination")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("ssb_sc_phase_discrimination")
        ...
        self.settings = Qt.QSettings("GNU Radio", "ssb_sc_phase_discrimination")
        ...
        self.analog_sig_source_x_1_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 10000, carrier_amplitude, 0, 0)
        self.analog_sig_source_x_1 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 10000, carrier_amplitude, 0, 0)
        self.analog_sig_source_x_1.set_block_alias("carrier_signal")
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 1500, msg_amplitude, 0, 0)
...
def main(top_block_cls=ssb_sc_phase_discrimination, options=None):
