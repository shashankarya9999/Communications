...
# Generated: Mon Dec 16 00:29:37 2024
##################################################
...
class sineWaveFlowgraph(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Blocks
        ##################################################
        self._frequency_range = Range(-samp_rate/2, +samp_rate/2, 100, 1000, 200)
        ...
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, frequency, 1, 0)
