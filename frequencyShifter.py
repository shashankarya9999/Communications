...
# Generated: Sun Dec 15 22:21:57 2024
##################################################
...
class frequencyShifter(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "frequencyShifter")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("frequencyShifter")
        ...
        self.settings = Qt.QSettings("GNU Radio", "frequencyShifter")
...
def main(top_block_cls=frequencyShifter, options=None):
